!(function (e, t) {
  ...
  function o() {
    ...
    for (var c in l)
      if (l.hasOwnProperty(c)) {
        ...
        for (n = i(t.fn, "function") ? t.fn() : t.fn, s = 0; s < e.length; s++)
          (a = e[s]),
            (r = a.split(".")),
            1 === r.length
              ? (u[r[0]] = n)
  ...
  function r(e, i, o, n) {
    ...
    if (parseInt(o, 10))
      for (; o--; )
        (l = s("div")), (l.id = n ? n[o] : u + (o + 1)), h.appendChild(l);
    return (
      (r = s("style")),
      (r.type = "text/css"),
      (r.id = "s" + u),
      ...
      (d = i(h, e)),
      f.fake
        ? (f.parentNode.removeChild(f), (p.style.overflow = c), p.offsetHeight)
            ...
            ((function (t, i) {
              (t.initialized = !0),
                i.each(function () {
                  ...
                  (n.sidebar = e(this)),
                    (n.options = t || {}),
                    (n.container = e(n.options.containerSelector)),
                    0 == n.container.length &&
                      (n.container = n.sidebar.parent()),
                    n.sidebar.css({
                    ...
                    (n.paddingBottom = parseInt(
                      n.sidebar.css("padding-bottom")
                    ));
                      ...
                      if (n.stickySidebar.is(":visible"))
                        if (e("body").width() < n.options.minWidth) i();
                          ...
                          if (n.options.disableOnResponsiveLayouts) {
                            var s = n.sidebar.outerWidth(
                              "none" == n.sidebar.css("float")
                            );
                          ...
                          if (
                            ...
                            var c,
                              u = n.paddingTop + t.additionalMarginTop,
                              h =
                                n.paddingBottom +
                                n.marginBottom +
                              ...
                              g =
                                n.stickySidebar.outerHeight() + u + h <
                                e(window).height();
                            c = g
                              ? m + n.stickySidebar.outerHeight()
                              : e(window).height() -
                                n.marginBottom -
                                n.paddingBottom -
                                t.additionalMarginBottom;
                            ...
                            "fixed" == n.stickySidebar.css("position") &&
                              ...
                              "stick-to-top" == n.options.sidebarBehavior &&
                                (b = t.additionalMarginTop),
                              "stick-to-bottom" == n.options.sidebarBehavior &&
                                (b = c - n.stickySidebar.outerHeight()),
                              (b =
                                w > 0
                                  ? Math.min(b, m)
                                  : Math.max(
                                      b,
                                      c - n.stickySidebar.outerHeight()
                                    )),
                              (b = Math.max(b, v)),
                              (b = Math.min(
                                b,
                                y - n.stickySidebar.outerHeight()
                              ));
                            var k =
                              n.container.height() ==
                            ...
                            l =
                              (!k && b == m) ||
                              (!k && b == c - n.stickySidebar.outerHeight())
                                ? "fixed"
                                : d +
                                    b -
                                    n.sidebar.offset().top -
                          ...
                          "static" != l &&
                            ...
                            n.sidebar.hasClass("is-alreay-loaded") ||
                              (tie_animate_element(n.sidebar),
                              n.sidebar.addClass("is-alreay-loaded"))),
  ...
  !(function (e) {
    e &&
      (e.fn.tiesticky = function (t) {
        return this.each(function () {
          var i = e(this),
            o = i.data("tiesticky"),
            n = "object" == typeof t && t;
          (n = e.extend(!0, {}, TieSticky.options, n)),
            o || ((o = new TieSticky(this, n)).init(), i.data("tiesticky", o)),
            "string" == typeof t &&
              (o[t](), "destroy" === t && i.removeData("tiesticky"));
        });
      });
  })(window.jQuery),
  (function (e, t) {
    ...
    function t(e, i) {
      ...
      (i = (function n(e) {
        ...
        (this.elem = e),
        (this.tolerance =
          (o = i.tolerance) === Object(o) ? o : { down: o, up: o }),
        ...
        (this.offset =
          "default" != this.behaviorMode
            ? this.offset + this.elem.offsetHeight
            : this.offset),
        (this.offset = $body.hasClass("admin-bar")
          ? this.offset - i.adminBarH
          : this.offset),
        (this.offset = $body.hasClass("border-layout")
          ? this.offset - 25
          : this.offset),
        (this.offset =
          $body.hasClass("border-layout") && this.windwidth < 992
            ? this.offset + 25
            : this.offset),
    ...
    return (
      ...
      (t.prototype = {
        ...
        update: function () {
          ...
          this.isOutOfBounds(e) ||
            ("default" == this.behaviorMode &&
            this.isHightestThanSticky &&
            this.offset < e &&
            e < this.offset + this.heightDiff
              ? this.elem.classList.add("just-before-sticky")
              : this.elem.classList.remove("just-before-sticky"),
            e <= this.offset - this.elem.offsetHeight &&
            "default" != this.behaviorMode
              ? (this.top(), this.elem.classList.add("unpinned-no-transition"))
              : e <= this.offset && "default" == this.behaviorMode
              ? this.top()
              : e > this.offset &&
                (this.notTop(),
                "default" == this.behaviorMode &&
      ...
      (t.cutsTheMustard = void 0 !== i && i.rAF && i.bind && i.classList),
      t
    );
  });
var megaMenuAjax = !1;
jQuery(document).ready(function () {
  ...
  function e(e, t, i, o) {
    ...
    n &&
      ...
      i ? ((a = o), (r = !1)) : e.hasClass("menu-item-has-children") && (a = 4),
      megaMenuAjax && 4 != megaMenuAjax.readystate && megaMenuAjax.abort(),
      (megaMenuAjax = jQuery.ajax({
        ...
        beforeSend: function () {
          t.find(".loader-overlay").length ||
            t.addClass("is-loading").append(tie.ajax_loader);
        },
        success: function (e) {
          if (r) var i = jQuery(e);
          ...
          var o = t
              .find("#loaded-" + n + ", .mega-check-also ul")
              .show()
              .find("li"),
          ...
          s.add(o).each(function () {
            a++,
              jQuery(this)
                ...
                .attr("style", "animation-delay: 0." + a + "s");
          }),
    ...
    if ($mainNav.length) {
      ...
      if (t > 992) {
        $body.hasClass("admin-bar") &&
          ((e = 783 > t ? 46 : 32), (e = 601 > t ? 0 : e));
        var i = $mainNav.outerHeight();
        $mainNav.parent().css({ height: i }),
  ...
  $mainNav.on("mouseenter", ".mega-recent-featured, .mega-cat", function () {
    var t = jQuery(this),
      ...
      n = 0;
    t.hasClass("mega-cat") &&
      ((o = !0), (n = 5), t.has(".cats-vertical").length && (n = 4)),
      e(t, i, o, n);
  }),
    $mainNav.on("mouseenter", ".mega-sub-cat", function () {
      ...
      if (!t.hasClass("is-active")) {
        var o = t.closest(".mega-menu"),
          ...
          s = 5;
        if (
          (o.has(".cats-vertical").length && (s = 4),
          o.find(".mega-sub-cat").removeClass("is-active"),
          t.addClass("is-active"),
          n.find("#loaded-" + i).length)
        ) {
          n.find("ul").hide();
    ...
    tie.sticky_desktop && (t(), $window.resize(t)),
    i(),
    jQuery("nav > ul", "#theme-header").on(
  ...
  o.match(/iPad/i) &&
    ...
    o.search("Chrome") < 0 &&
    jQuery(
      "#main-nav li.menu-item-has-children a, #main-nav li.mega-menu a, .top-bar li.menu-item-has-children a"

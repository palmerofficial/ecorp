!(function (i) {
  ...
  (e = (function () {
        ...
        o.unload(),
          "number" == typeof s
            ? 0 === s && 0 === o.$slides.length
              ...
              : t
              ? i(e).insertBefore(o.$slides.eq(s))
              : i(e).insertAfter(o.$slides.eq(s))
            : t === !0
      ...
      if (t.options.dots === !0 && t.slideCount > t.options.slidesToShow) {
        for (
          t.$slider.addClass("slick-dotted"),
            s = i("<ul />").addClass(t.options.dotsClass),
            e = 0;
          e <= t.getDotCount();
          e += 1
        )
    ...
    (e.prototype.checkResponsive = function (e, s) {
      ...
      if (
        ...
        for (t in l.breakpoints)
          l.breakpoints.hasOwnProperty(t) &&
            (l.originalSettings.mobileFirst === !1
              ? n < l.breakpoints[t] && (o = l.breakpoints[t])
              : n > l.breakpoints[t] && (o = l.breakpoints[t]));
        null !== o
      ...
      switch (
        ...
        case "index":
          var d =
            0 === e.data.index
              ? 0
              : e.data.index || r.index() * l.options.slidesToScroll;
    ...
    (e.prototype.fadeSlide = function (i, e) {
      ...
      s.cssTransitions === !1
        ? (s.$slides.eq(i).css({ zIndex: s.options.zIndex }),
          s.$slides
            .eq(i)
            .animate({ opacity: 1 }, s.options.speed, s.options.easing, e))
        : (s.applyTransition(i),
        ...
        .on("focus.slick blur.slick", "*:not(.slick-arrow)", function (s) {
          ...
          setTimeout(function () {
            e.options.pauseOnFocus &&
              ((e.focussed = t.is(":focus")), e.autoPlay());
          }, 0);
        });
    }),
    ...
    (e.prototype.getSlideCount = function () {
      ...
      return (
        ...
        o.options.swipeToSlide === !0
          ? (o.$slideTrack.find(".slick-slide").each(function (e, n) {
              return n.offsetLeft - t + i(n).outerWidth() / 2 > -1 * o.swipeLeft
                ? ((s = n), !1)
                : void 0;
            }),
            (e = Math.abs(i(s).attr("data-slick-index") - o.currentSlide) || 1))
    ...
    (e.prototype.goTo = e.prototype.slickGoTo =
      function (i, e) {
        var s = this;
        s.changeSlide({ data: { message: "index", index: parseInt(i) } }, e);
      }),
    ...
    (e.prototype.lazyLoad = function () {
      ...
      l.options.centerMode === !0
        ...
        : ((o = l.options.infinite
            ...
            : l.currentSlide),
          (n = Math.ceil(o + l.options.slidesToShow)),
          l.options.fade === !0 && (o > 0 && o--, n <= l.slideCount && n++)),
        (s = l.$slider.find(".slick-slide").slice(o, n)),
        e(s),
        l.slideCount <= l.options.slidesToShow
          ? ((t = l.$slider.find(".slick-slide")), e(t))
          ...
          (o.onerror = function () {
            3 > e
              ...
              : (s
                  ...
                  .removeClass("slick-loading")
                  .addClass("slick-lazyload-error"),
                n.$slider.trigger("lazyLoadError", [n, s, t]),
                n.progressiveLazyLoad());
          }),
          (o.src = t))
    ...
    (e.prototype.removeSlide = e.prototype.slickRemove =
      function (i, e, s) {
        ...
        return (
          "boolean" == typeof i
            ? ((e = i), (i = e === !0 ? 0 : t.slideCount - 1))
            : (i = e === !0 ? --i : i),
          t.slideCount < 1 || 0 > i || i > t.slideCount - 1
            ? !1
            : (t.unload(),
              s === !0
                ? t.$slideTrack.children().remove()
                : t.$slideTrack.children(this.options.slide).eq(i).remove(),
    ...
    (e.prototype.setCSS = function (i) {
      ...
      t.options.rtl === !0 && (i = -i),
        ...
        t.transformsEnabled === !1
          ...
          : ((o = {}),
            t.cssTransitions === !1
              ? ((o[t.animType] = "translate(" + e + ", " + s + ")"),
                t.$slideTrack.css(o))
              : ((o[t.animType] = "translate3d(" + e + ", " + s + ", 0px)"),
                t.$slideTrack.css(o)));
    }),
      ...
      function () {
        ...
        if (
          ("object" === i.type(arguments[0])
            ? ((t = arguments[0]), (r = arguments[1]), (n = "multiple"))
          ...
          for (s in o)
            if ("array" !== i.type(l.options.responsive))
              ...
              for (e = l.options.responsive.length - 1; e >= 0; )
                l.options.responsive[e].breakpoint === o[s].breakpoint &&
      ...
      (s = n.$slider
        ...
        n.options.centerMode === !0
          ...
          : ((o = n.slideCount % n.options.slidesToShow),
            (t = n.options.infinite === !0 ? n.options.slidesToShow + i : i),
            n.options.slidesToShow == n.options.slidesToScroll &&
            n.slideCount - i < n.options.slidesToShow
              ? s
                  .slice(t - (n.options.slidesToShow - o), t + o)
                  .addClass("slick-active")
                  .attr("aria-hidden", "false")
              : s
    ...
    (e.prototype.selectHandler = function (e) {
      ...
      return (
        ...
        s.slideCount <= s.options.slidesToShow
          ? (s.setSlideClasses(o), void s.asNavFor(o))
          : void s.slideHandler(o)
      );
    }),
          ...
          : ((e = l.getLeft(l.currentSlide)),
            ...
            "vertical" !== s
              ? (void 0 !== i.originalEvent &&
                ...
                (t = l.touchObject.swipeLength),
                (l.touchObject.edgeHit = !1),
                l.options.infinite === !1 &&
                  ((0 === l.currentSlide && "right" === s) ||
                    (l.currentSlide >= l.getDotCount() && "left" === s)) &&
                  ((t = l.touchObject.swipeLength * l.options.edgeFriction),
                  (l.touchObject.edgeHit = !0)),
                l.options.vertical === !1
                  ? (l.swipeLeft = e + t * o)
                  : (l.swipeLeft =
                      e + t * (l.$list.height() / l.listWidth) * o),
                l.options.verticalSwiping === !0 && (l.swipeLeft = e + t * o),
      ...
      for (i = 0; l > i; i++)
        if (
          ("object" == typeof o || "undefined" == typeof o
            ? (t[i].slick = new e(t[i], o))
            : (s = t[i].slick[o].apply(t[i].slick, n)),
          "undefined" != typeof s)
        )
          return s;
      return t;
...
jQuery(document).ready(function () {
    ...
    (i.each(function (i) {
      ...
      1 == s.parents(".latest-poroducts-slider-box").length && (e = ".product"),
        ...
        s.slick({
          ...
          prevArrow:
            '<li><a><span class="tie-icon-angle-left"></span></a></li>',
          nextArrow:
            '<li><a><span class="tie-icon-angle-right"></span></a></li>',
          infinite: !0,
          responsive: [
            {
              breakpoint: 1024,
              settings: { slidesToShow: t ? 4 : 3, slidesToScroll: t ? 4 : 3 },
            },
            {
              breakpoint: 992,
  ...
  s.length &&
    s.each(function (i) {
      ...
      if (
        (t.closest(".main-slider").attr("id", s),
        1 == t.parents(".fullwidth-area").length)
      )
        var n = 5,
          e = [
            {
      ...
      o.slick({
        ...
        tie.lazyload &&
          jQuery(o).on("lazyLoaded", function (i, e, s, t) {
            s.hide(),
    ...
    jQuery(".tie-slick-slider-wrapper").each(function () {
      ...
      if (2 == o)
        (d.asNavFor = ""),
          ...
          l
            ? ((d.slidesToShow = 2),
              ...
              (d.slidesOn1024 = 1))
            : r &&
              ((d.slidesToShow = is_boxed_layout ? 3 : 4),
              (d.slidesToScroll = is_boxed_layout ? 3 : 4),
              (d.slidesOn1280 = 3));
      else if (4 == o || 50 == o) {
        (d.asNavFor = i
          .next(".wide-slider-nav-wrapper")
          .find(".tie-slick-slider")),
          (d.infinite = !0),
          (d.showArrows = !1),
        ...
        50 == o && (d.fade = !0),
          c.length &&
            ...
            a.css({ opacity: 1 }).find(".loader-overlay").remove());
      } else
        3 == o || o > 8
          ? ((d.asNavFor = ""), (d.infinite = !0))
          : 5 == o
          ? ((d.infinite = !0),
            (d.slidesToShow = 3),
            (d.slidesToScroll = 3),
      ...
      3 == o && (d.centerMode = !0),
        ...
        tie.lazyload &&
          jQuery(s).on("lazyLoaded", function (i, e, s, t) {
            s.hide(),
              s.next(".slide-bg").css("background-image", 'url("' + t + '")');
          }),
        (2 == o || 5 == o || 6 == o || 7 == o) &&
          jQuery(s).fadeIn(1e3, function () {

...
(function (g, p, Q) {
  ...
  fa.prototype = {
    ...
    loadContent: function (a, b, c) {
      ...
      /*console.warn("loadContent",arguments);*/ this.loadSwitcher(a, d, e, b);
    },
...
!(function (a, b, c) {
  for (
    var e,
      ...
      h = 0,
      i = g.length;
    h < i && !b.requestAnimationFrame;
    ++h
  )
    (b.requestAnimationFrame = b[g[h] + "RequestAnimationFrame"]),
      (b.cancelAnimationFrame =
        b[g[h] + "CancelAnimationFrame"] ||
        b[g[h] + "CancelRequestAnimationFrame"]);
...
jQuery(document).ready(function () {
  ...
  if (tie.lightbox_all) {
    $entryContent
      .find("a")
      .not(".gallery a")
      .not(".wp-block-gallery a")
      .not(".tiled-gallery a")
      .each(function (i, el) {
        var href_value = el.href;
        if (
          /\.(jpg|jpeg|png|gif|webp)$/.test(href_value.replace("?ssl=1", ""))
        ) {
          //?ssl added by JetPack
  ...
  if (tie.lightbox_gallery) {
    $entryContent
      .find(".gallery a, .wp-block-gallery a, .tiled-gallery a")
      .each(function (i, el) {
        var href_value = el.href;
